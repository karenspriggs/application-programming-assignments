...
using AuthenticationExample;
using AuthenticationExample.Services;
...
namespace AuthenticationExample.Controllers
{
    public class UsersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserID,First_Name,Last_Name,Username,Password")] User user)
        {
            if (ModelState.IsValid)
            {
